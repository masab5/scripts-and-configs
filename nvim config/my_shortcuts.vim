...
" Compiler commands
autocmd FileType python nnoremap <leader>r :w <cr> :!echo "%">~/Desktop/.temp/.filename.txt<cr>:!sh ~/Scripts/pycompiler<cr>
autocmd FileType c nnoremap <leader>r :w <cr> :!echo "%">~/Desktop/.temp/.filename.txt<cr>:!sh ~/Scripts/c_compiler<cr>
autocmd FileType cpp nnoremap <leader>r :w <cr> :!echo "%">~/Desktop/.temp/.filename.txt<cr>:!sh ~/Scripts/cpp_compiler<cr>

nnoremap <leader>d diw " Delete a word with space d
nnoremap <leader>c ciw " Delete a word with space c
